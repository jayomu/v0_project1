...
export default function DobutamineCalculator() {
  // Default values
  ...
  const [doseSlider, setDoseSlider] = useState(5) // Renamed for clarity
  ...
  return (
    <div className="flex flex-col bg-gray-50 p-6 rounded-lg shadow-lg max-w-2xl mx-auto text-gray-800">
      <h1 className="text-2xl font-bold text-center text-blue-800 mb-6">Dobutamine Infusion Calculator</h1>
      ...
      <div className="bg-white p-4 rounded-md shadow mb-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium mb-1">Dobutamine (ml)</label>
            <input
              type="number"
              value={dopamineMl}
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Dobutamine (mg)</label>
            <input
              type="number"
              value={dopamineMg}
      ...
      <div className="bg-white p-4 rounded-md shadow mb-6">
        ...
        {/* Usual dose range (5-20mcg/kg/min) */}
        <div className="mb-6 p-3 bg-green-50 rounded-md">
          <h3 className="font-medium text-green-800 mb-2">Usual dose range (5-20 mcg/kg/min)</h3>
          <label className="block text-sm mb-1">Dose: {formatNumber(doseSlider)} mcg/kg/min</label>
          <input
            type="range"
            min="0"
            max="20"
          ...
          <div className="mt-2 p-2 bg-white rounded-md text-center">
            ...
            <p className="font-bold text-xl text-green-700">
              {formatNumber(calculateRateFromMcgKgMin(doseSlider))} ml/hr
            </p>
          </div>
        </div>
      </div>
